...
#   * expected UDF entry points are missing from .dynsym
#
...
# Assertion 5: UDF entry points are in .dynsym. Without these, MySQL's
...
echo "ok: all UDF entry points exported"
